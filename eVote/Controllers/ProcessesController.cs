    ...
    public class ProcessesController : Controller
    {
        ...
        List<VoteProcess> _processes = new List<VoteProcess> {
            ...
            new VoteProcess {
                ...
                Countries = new  List<Country> { new Country {Name="Peru", ImgURL="/Content/img/flags/PE.gif" }, new Country {Name="Colombia", ImgURL="/Content/img/flags/CO.gif" }, new Country {Name="Ecuador", ImgURL="/Content/img/flags/EC.gif" } },
                CaseId = "P-222-222",
                StartDate=DateTime.Now.Date,
                EndDate=DateTime.Now.Date,
                StatusId=1
            ...
            new VoteProcess {
                ...
                Countries = new  List<Country> { new Country {Name="Uruguay", ImgURL="/Content/img/flags/UR.gif" } },
                CaseId = "P-555-555",
                StartDate=DateTime.Now.Date,
                EndDate=DateTime.Now.Date,
                StatusId=2
            ...
            new VoteProcess {
                ...
                Subject = new Subject{ Name="LGBTI" },
                Countries = new  List<Country> { new Country {Name="Panamá", ImgURL= "/Content/img/flags/PN.gif" } },
                CaseId = "P-666-666",
                StartDate=DateTime.Now.Date,
                EndDate=DateTime.Now.Date,
                StatusId=2
            ...
            new VoteProcess {
                ...
                Subject = new Subject{ Name="Niños" },
                Countries = new  List<Country> { new Country {Name="Ecuador", ImgURL= "/Content/img/flags/EC.gif" } },
                CaseId = "P-777-777",
                StartDate=DateTime.Now.Date,
                EndDate=DateTime.Now.Date,
                StatusId=2
            ...
            new VoteProcess {
                ...
                Category = new Category { Name = "Comunicado de prensa" },
                Subject = new Subject{ Name="Mujeres" },
                Countries = new  List<Country> { new Country {Name="Brasil", ImgURL="/Content/img/flags/BR.gif" } },
                CaseId = "P-888-888",
                StartDate=DateTime.Now.Date,
                EndDate=DateTime.Now.Date,
                StatusId=2
            ...
            new VoteProcess {
                ...
                Countries = new  List<Country> { new Country {Name="Mexico", ImgURL= "/Content/img/flags/MX.gif" } },
                CaseId = "P-101-010",
                StartDate=DateTime.Now.Date,
                EndDate=DateTime.Now.Date,
                StatusId=3
